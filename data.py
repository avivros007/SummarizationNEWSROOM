  ...
  while True:
    ...
    for f in filelist:
      ...
      for entry in reader:
        ...
        if curr_text == None or len(curr_text) == 0 or curr_summ == None or len(curr_summ) == 0:
          continue
        ...
        tf_example.features.feature['article'].bytes_list.value.extend([curr_text])
        tf_example.features.feature['abstract'].bytes_list.value.extend([curr_summ])
        yield tf_example
    if single_pass:
